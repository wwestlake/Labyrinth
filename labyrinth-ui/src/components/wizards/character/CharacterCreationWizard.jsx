  ...
  const handleNext = async () => {
    if (currentStep === 0 && !character) {
      ...
      try {
        ...
        // Construct the payload as required by your backend
        ...
        const createdCharacter = await createCharacter(requestPayload); // Call the API to create the character
      ...
      <div className="steps-content">
        {currentStep === 0 && (
          <BasicInfoStep 
            ...
            characterCreated={character !== null} // Pass character creation state to BasicInfoStep
          />
        )}
        {currentStep === 1 && (
